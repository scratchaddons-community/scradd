...
describe("bigintPow", () => {
	it("should correctly calculate the power of a bigint when exponent is 0", () => {
		strictEqual(bigIntPower(2n, 0n), 1n);
	});
	it("should correctly calculate the power of a bigint when exponent is 1", () => {
		strictEqual(bigIntPower(2n, 1n), 2n);
	});
	it("should correctly calculate the power of a bigint when exponent is even", () => {
		strictEqual(bigIntPower(3n, 4n), 81n);
	});
	it("should correctly calculate the power of a bigint when exponent is odd", () => {
		strictEqual(bigIntPower(2n, 3n), 8n);
	});
	it("should correctly calculate the power of a bigint with a large exponent", () => {
		strictEqual(bigIntPower(2n, 100n), 1_267_650_600_228_229_401_496_703_205_376n);
	});
	it("should correctly calculate the power of a negative bigint", () => {
		strictEqual(bigIntPower(-2n, 3n), -8n);
	});
});

describe("convertBase", () => {
	it("should convert base 16 to 10", () => {
		strictEqual(convertBase("8F", 16, 10), "143");
	});
	it("should convert base 16 to 2", () => {
		strictEqual(convertBase("A", 16, 2), "1010");
	});
	it("should convert an empty input string to 0", () => {
		strictEqual(convertBase("", 16, 10), "0");
	});
	it("should convert BigInts too", () => {
		const input =
...
describe("nth", () => {
	it("should return `th` for numbers ending in 0", () => {
	...
	it("should return `th` for numbers ending in 4-9", () => {
	...
	it("should return `th` for numbers ending in 11-13", () => {
...
describe("parseTime", () => {
	it("should support UNIX timestamps", () => {
	...
	it("should return the current time on an invalid value", () => {
