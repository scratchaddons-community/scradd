...
export default /** @type {import("discord.js").Collection<string,{
	data: Omit<import("@discordjs/builders").SlashCommandBuilder, "addSubcommand" | "addSubcommandGroup">,
	interaction: (interaction: import("discord.js").CommandInteraction<import("discord.js").CacheType>) => (Promise<void> | void);
}>}*/(commands)
