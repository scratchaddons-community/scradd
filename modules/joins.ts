						...
						fields: [
							{
								...
								value:
									...
									` Scratch Addons combines new and existing features and themes for [the Scratch website and project editor](${constants.domains.scratch}) into one __easy-to-access and configurable__ browser extension.` +
									` For more information about us, **visit [ScratchAddons.com](${constants.domains.scratchAddons})**.` +
									` If you have any questions about or issues with Scratch Addons, please ask in ${config.channels.support?.toString() ?? "our support channel"}!`,
							},
							{
							...
							},
							{
								...
								value:
									...
									` If you wish to contact the Scratch Team, please use [Contact Us](<${constants.domains.scratch}/contact-us>).` +
