	...
	switch (message.type) {
		...
		case "CHANNEL_NAME_CHANGE": {
			return (
				...
				` ${message.author.toString()} changed the channel name${
		...
		case "CHANNEL_PINNED_MESSAGE": {
			...
			return (
				...
				` ${message.author.toString()} pinned [a message](<https://discord.com/channels/${
					pinned.guild?.id || "@me"
				}/${pinned.channel?.id || ""}/${
					pinned.id
		...
		case "REPLY": {
			...
			return `*Replying to ${message.author.toString()}${
