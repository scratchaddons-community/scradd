 ...
 *   [discord-fetch-all](https://github.com/iColtz/discord-fetch-all/blob/b2c4322/src/functions/fetchMessages.ts).
 ...
 *   `system_content`](https://github.com/Rapptz/discord.py/blob/55849d9/discord/message.py#L1827-L1943).
 ...
 * ) => Promise<import("discord.js").Message>} reply
 */
...
export async function paginate(array, toString, failMessage, title, reply) {
	...
	collector
		...
		.on("end", async () => {
			...
			await reply({
				components: [
					new MessageActionRowBuilder().addComponents(previousButton, nextButton),
				],
